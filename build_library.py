...
add("IBM-MQ-CLIENT", "IBM", "MQ Client", "", "", "Not separately licensable (bundled client component)", ["MQ Client"])
add("IBM-WMQ-JAVA", "IBM", "WebSphere MQ Java", "", "", "Not separately licensable (bundled component)", ["WebSphere MQ Java"])
add("IBM-WMQ-MFT-TOOLS", "IBM", "WebSphere MQ Managed File Transfer Tools", "", "", "Not separately licensable (bundled component)",
    ["WebSphere MQ Managed File Transfer Tools"])
add("IBM-WMQ-MFT-LOGGER", "IBM", "WebSphere MQ Managed File Transfer Logger", "", "", "Not separately licensable (bundled component)",
    ["WebSphere MQ Managed File Transfer Logger"])
add("IBM-WMQ-MFT-BASE", "IBM", "WebSphere MQ Managed File Transfer Base", "", "", "Not separately licensable (bundled component)",
...
add("IBM-OPENPAGES-LOSSEVENT", "IBM", "OpenPages Loss Event Entry", "", "", "Not separately licensable (bundled component per Flexera classification)",
...
add("IBM-HOST-ACCESS-TOOLKIT", "IBM", "Host Access Toolkit", "", "", "Not separately licensable (bundled dev toolkit per Flexera classification)",
    ["Host Access Toolkit"])
...
add("IBM-DATAPOWER-X3-AOM", "IBM", "DataPower Gateway X3 Application Optimization Module", "", "", "Not separately licensable (bundled module)",
...
add("IBM-DATAPOWER-X2-AOM", "IBM", "DataPower Gateway X2 Application Optimization Module", "", "", "Not separately licensable (bundled module)",
...
add("IBM-STORAGE-PROTECT-API", "IBM", "Storage Protect Client Application Programming Interface", "", "", "Not separately licensable (bundled API component)",
...
add("IBM-SEMERU-RUNTIME", "IBM", "Semeru Runtime Open Edition", "", "", "Free (IBM's OpenJDK distribution - no license required)",
...
add("IBM-PROGRAM-LAUNCHER", "IBM", "Program Launcher", "", "", "Not separately licensable (bundled launcher component)",
    ["IBM Program Launcher", "Program Launcher"])
add("IBM-DEV-KIT-JAVA", "IBM", "Developer Kit for Windows, Java", "", "", "Bundled Java runtime - verify if standalone or embedded in another product",
...
add("VMWARE-TOOLS", "VMware (Broadcom)", "VMware Tools", "", "", "Not separately licensable (bundled guest agent)", ["VMware Tools"])
...
for app in ["Photoshop", "Illustrator", "InDesign", "Premiere Pro", "After Effects", "Lightroom",
    ...
    add(f"ADOBE-CC-{slug}", "Adobe", app, "Single App", "", "Named User Subscription",
        aliases, "Commercial")

add("ADOBE-CC-PREMIERE-RUSH", "Adobe", "Premiere Rush", "Single App", "", "Named User Subscription",
    ["Adobe Premiere Rush", "Premiere Rush", "Premiere Rush CC"], "Commercial")
...
add("ADOBE-ACROBAT-READER", "Adobe", "Adobe Acrobat Reader", "", "", "Free (no license required)",
...
add("ADOBE-READER-XI", "Adobe", "Adobe Reader", "XI", "11", "Free (legacy - pre-DC, discontinued, unsupported)",
    ["Adobe Reader XI", "Adobe Reader XI MUI", "Adobe Reader 11"])
add("ADOBE-FLASH-PLAYER", "Adobe", "Flash Player", "", "32", "Free (DISCONTINUED Dec 2020 - security risk, flag for removal)",
...
add("ADOBE-ARM", "Adobe", "Adobe Acrobat/Reader Update Component", "", "", "Not separately licensable (bundled updater)",
    ["Adobe Refresh Manager", "Adobe ARM", "Adobe Acrobat Update Service"])
add("ADOBE-LANGPACK", "Adobe", "Adobe Acrobat/Reader Language Pack", "", "", "Not separately licensable (bundled language/font component)",
...
add("ADOBE-GENUINE", "Adobe", "Adobe Genuine Software Integrity Service", "", "", "Not separately licensable (bundled service)",
...
add("ADOBE-CC-DESKTOP", "Adobe", "Creative Cloud Desktop App", "", "", "Not separately licensable (launcher/updater for CC apps)",
    ["Adobe Creative Cloud", "Adobe Creative Cloud Desktop", "Creative Cloud Desktop", "Adobe Desktop Service"])
add("ADOBE-CC-SYNC", "Adobe", "Creative Cloud Sync", "", "", "Not separately licensable (bundled asset-sync component)",
    ["Adobe Sync", "Adobe Creative Cloud Sync", "Core Sync"])
add("ADOBE-CC-LIBRARIES", "Adobe", "Creative Cloud Libraries", "", "", "Not separately licensable (bundled shared-asset component)",
    ["Creative Cloud Libraries", "Adobe Creative Cloud Libraries"])
add("ADOBE-CAI", "Adobe", "Content Authenticity Initiative", "", "", "Not separately licensable (bundled component)",
    ["Adobe CAI", "Content Authenticity Initiative", "Content Credentials"])
add("ADOBE-UXP", "Adobe", "UXP Extensions Framework", "", "", "Not separately licensable (bundled shared framework)",
    ["Adobe UXP", "UXP Extensions", "Adobe UXP Extensions"])
add("ADOBE-OS-EXTENSION", "Adobe", "Adobe OS Extension", "", "", "Not separately licensable (bundled OS integration component)",
...
add("SAP-GUI", "SAP", "SAP GUI", "", "", "Not separately licensable (client access component)", ["SAP GUI", "SAP Logon", "SAPGUI"])
...
add("CITRIX-WORKSPACE-APP", "Citrix (Cloud Software Group)", "Workspace App", "", "", "Free client (bundled with Citrix subscription)",
...
add("POSTGRESQL", "PostgreSQL Global Development Group", "PostgreSQL", "", "", "Free (PostgreSQL License; no license required)", ["PostgreSQL", "Postgres"])
add("APACHE-TOMCAT", "Apache Software Foundation", "Apache Tomcat", "", "", "Free (Apache License 2.0)", ["Apache Tomcat", "Tomcat"])
add("APACHE-HTTPD", "Apache Software Foundation", "Apache HTTP Server", "", "", "Free (Apache License 2.0)", ["Apache HTTP Server", "Apache2", "httpd"])
add("NGINX-OSS", "F5 (NGINX)", "nginx", "", "", "Free (BSD-2-Clause)", ["nginx", "nginx open source"])
...
# ============================== FREEWARE / COMPONENTS ==============================
# Publisher is always the REAL company - licensability is carried by the
# classification field, never by a placeholder in the publisher column.
for name, publisher, aliases in [
    ("7-Zip",            "Igor Pavlov",                  ["7-Zip", "7Zip", "7z"]),
    ("Notepad++",        "Notepad++ Team",               ["Notepad++", "Notepad Plus Plus"]),
    ("Google Chrome",    "Google",                       ["Google Chrome", "Chrome"]),
    ("Mozilla Firefox",  "Mozilla",                      ["Mozilla Firefox", "Firefox"]),
    ("Microsoft Edge",   "Microsoft",                    ["Microsoft Edge", "Edge"]),
    ("VLC Media Player", "VideoLAN",                     ["VLC Media Player", "VLC"]),
    ("PuTTY",            "Simon Tatham",                 ["PuTTY"]),
    ("WinSCP",           "WinSCP",                       ["WinSCP"]),
    ("FileZilla",        "FileZilla Project",            ["FileZilla"]),
    ("Git",              "Git Project",                  ["Git", "Git for Windows"]),
    ("Python",           "Python Software Foundation",   ["Python", "Python 3"]),
    ("Node.js",          "OpenJS Foundation",            ["Node.js", "NodeJS"]),
    ("Wireshark",        "Wireshark Foundation",         ["Wireshark"]),
    ("Audacity",         "Audacity Team",                ["Audacity"]),
    ("GIMP",             "GIMP Project",                 ["GIMP"]),
]:
    slug = "".join(c for c in name.upper() if c.isalnum())
    add(f"FREE-{slug}", publisher, name, "", "", "Free (no license required)", aliases, "Freeware")

for name, publisher, aliases in [
    ("Microsoft Visual C++ Redistributable", "Microsoft", ["Microsoft Visual C++ Redistributable", "Visual C++ Redistributable", "VC++ Redistributable"]),
    (".NET Framework",                 "Microsoft", [".NET Framework", "Microsoft .NET Framework", "dotnet framework"]),
    (".NET Runtime",                   "Microsoft", [".NET Runtime", "Microsoft .NET Runtime", "dotnet runtime"]),
    ("Java Runtime Environment",       "Oracle",    ["Java Runtime Environment", "JRE", "Java 8 Update"]),
    ("Microsoft Update Health Tools",  "Microsoft", ["Microsoft Update Health Tools", "Update Health Tools"]),
    ("Microsoft Edge WebView2 Runtime","Microsoft", ["Microsoft Edge WebView2 Runtime", "WebView2 Runtime"]),
    ("Intel Driver Package",           "Intel",     ["Intel Driver", "Intel Chipset Device Software"]),
    ("NVIDIA Graphics Driver",         "NVIDIA",    ["NVIDIA Graphics Driver", "NVIDIA Display Driver"]),
]:
    slug = "".join(c for c in name.upper() if c.isalnum())[:20]
    add(f"COMP-{slug}", publisher, name, "", "", "Not separately licensable (runtime/driver/component)", aliases, "Component")
...
add("UNIT4-PRINT-FORMATTER", "Unit4", "Print Formatter", "", "", "Free (per Flexera classification)", ["Print Formatter"])
add("KEEPER-COMMANDER", "Keeper Security", "Commander", "", "", "Free CLI tool (per Flexera classification)", ["Commander", "Keeper Commander"])
...
add("CITRIX-VDA-DESKTOP", "Citrix (Cloud Software Group)", "Virtual Delivery Agent (VDA) Desktop", "", "", "Not separately licensable (bundled agent)",
    ["Virtual Delivery Agent (VDA) Desktop (Workstation)"], "Component")
add("CITRIX-STOREFRONT", "Citrix (Cloud Software Group)", "StoreFront", "", "", "Not separately licensable (bundled with VAD)",
...
add("CITRIX-SECURE-TICKETING", "Citrix (Cloud Software Group)", "Secure Ticketing Authority (STA)", "", "", "Not separately licensable (bundled component)",
    ["Secure Ticketing Authority (STA)"], "Commercial")
add("CITRIX-CLOUD-CONNECTOR", "Citrix (Cloud Software Group)", "Cloud Connector", "", "", "Not separately licensable (bundled cloud-hybrid agent)",
    ["Cloud Connector"], "Commercial")
add("CITRIX-MACHINE-CREATION", "Citrix (Cloud Software Group)", "Machine Creation Services", "", "", "Not separately licensable (bundled provisioning component)",
    ["Machine Creation Services"], "Component")
add("CITRIX-PROFILE-MGR", "Citrix (Cloud Software Group)", "User Profile Manager (Profile management)", "", "", "Not separately licensable (bundled component)",
    ["User Profile Manager (Profile management)"], "Component")
add("CITRIX-WEM-AGENT", "Citrix (Cloud Software Group)", "Workspace Environment Management (WEM) Agent", "", "", "Not separately licensable (bundled agent)",
    ["Workspace Environment Management (WEM) Agent"], "Component")
add("CITRIX-DIRECTOR", "Citrix (Cloud Software Group)", "Director", "", "", "Not separately licensable (bundled monitoring console)",
    ["Director 7"], "Component")
add("CITRIX-STUDIO", "Citrix (Cloud Software Group)", "Studio", "", "", "Not separately licensable (bundled management console)",
    ["Citrix Studio 7", "Desktop Studio 7"], "Component")
add("CITRIX-LICENSING", "Citrix (Cloud Software Group)", "Licensing", "", "", "Not separately licensable (license server component)",
    ["Citrix Licensing", "Citrix Licensing 11", "Citrix Licensing 16"], "Component")
add("CITRIX-NETSCALER-GW-PLUGIN", "Citrix (Cloud Software Group)", "NetScaler Gateway Plug-in", "", "", "Not separately licensable (bundled client)",
...
add("CITRIX-SUPPORTABILITY-TOOLS", "Citrix (Cloud Software Group)", "Supportability Tools", "", "", "Free diagnostic toolset",
...
add("CITRIX-ENTERPRISE-BROWSER", "Citrix (Cloud Software Group)", "Enterprise Browser", "", "", "Free (Chromium-based, bundled with Citrix Workspace)",
...
add("MS-EDGE-ROLLING", "Microsoft", "Edge", "", "", "Free (bundled with Windows)",
    ["Microsoft Edge"], "Freeware")
add("MS-COPILOT-EDGE-ROLLING", "Microsoft", "Copilot in Edge", "", "", "Free (bundled with Edge)",
...
add("CA-CLIENT-INTEGRATION-PLUGIN", "CA Technologies (Broadcom)", "Client Integration Plug-In", "", "", "Not separately licensable (bundled browser plugin)",
...
add("SYMANTEC-EP-CLIENT", "Symantec (Broadcom)", "Endpoint Protection Client", "", "14", "Not separately licensable (bundled agent)",
    ["Symantec Endpoint Protection Client 14"], "Component")
add("SYMANTEC-MGMT-AGENT", "Symantec (Broadcom)", "Management Agent", "", "7", "Not separately licensable (bundled agent)",
    ["Symantec Management Agent 7"], "Component")
add("SYMANTEC-WSS-AGENT", "Symantec (Broadcom)", "Web Security Service Agent (WSS Agent)", "", "", "Not separately licensable (bundled agent)",
...
add("VMWARE-VCENTER-CONVERTER", "VMware (Broadcom)", "vCenter Converter Standalone", "", "", "Free (P2V/V2V conversion tool)",
...
add("VMWARE-ESXI-COMPONENTS", "VMware (Broadcom)", "ESXi Components", "", "", "Not separately licensable (bundled with ESXi)",
...
add("VMWARE-VSPHERE-SYSLOG", "VMware (Broadcom)", "vSphere Syslog Collector", "", "5.5", "Not separately licensable (bundled component)",
    ["vSphere Syslog Collector 5.5"], "Component")
add("VMWARE-VSPHERE-UPDATE-MGR", "VMware (Broadcom)", "vSphere Update Manager Client", "", "5", "Not separately licensable (bundled component)",
    ["vSphere Update Manager Client 5"], "Component")
add("VMWARE-WEB-CLIENT-AUTH", "VMware (Broadcom)", "Web Security Service Auth Connector", "", "2.5", "Not separately licensable (bundled component)",
...
add("VMWARE-REMOTE-CONSOLE", "VMware (Broadcom)", "Remote Console", "", "", "Free (management console)",
...
add("VMWARE-WORKSTATION-PLAYER", "VMware (Broadcom)", "Workstation Player", "", "", "Free for personal use since 2024",
    ["Workstation Player 16.2"], "Freeware")
add("VMWARE-SALT", "VMware (Broadcom)", "Salt (Configuration Management)", "", "", "Not separately licensable (bundled automation tool)",
    ["Salt 3006", "Salt 3007", "salt-master 3006", "Salt-minion 3005", "Salt-minion 3006"], "Component")
add("VMWARE-SAN-HEALTH", "VMware (Broadcom)", "SAN Health / SAN", "", "", "Free diagnostic tool",
    ["SAN 4.1", "SAN Health 4.2"], "Freeware")
add("VMWARE-PHOTON-OS", "VMware (Broadcom)", "Photon OS", "", "", "Free (VMware's own minimal Linux distribution)",
    ["Photon"], "Freeware")
add("VMWARE-RABBITMQ", "VMware (Broadcom)", "RabbitMQ", "", "", "Not separately licensable (bundled messaging component)",
...
# Apply Flexera ARL-confirmed classification rules to entries that were
# added before the classification field existed (the 436 that default empty).
# Rules are applied in order; first match wins.
# Source: real Flexera ARL export screenshots provided across multiple sessions.

def _classify(cid, pub, fam, ed, metric, existing):
    """Return classification string for a single library entry."""
    if existing:                              # already set - keep it
        return existing

    pub_l  = str(pub).lower()
    fam_l  = str(fam).lower()
    cid_l  = str(cid).lower()
    met_l  = str(metric).lower()

    # ── Freeware rules ──────────────────────────────────────────────
    # NOTE: publisher is always a REAL company now - classification is
    # carried by this field alone, never by a placeholder publisher.

    # Specific free products confirmed from ARL
    freeware_families = {
        "sql server management studio", "sql server express",
        "sql server developer", "visual studio code", "git",
        "7-zip", "notepad++", "google chrome", "mozilla firefox",
        "microsoft edge", "vlc media player", "putty", "winscp",
        "filezilla", "wireshark", "audacity", "gimp", "python",
        "node.js", "openssl", "openssh",
        "adobe acrobat reader", "adobe reader",
        "semeru runtime open edition",
        "postgresql", "mysql community edition", "mariadb",
        "apache http server", "apache tomcat",
        "graalvm", "openjdk",
        "vm virtualbox",
        "workstation pro", "vmware fusion",           # free since 2024
        "remote console",                             # vmware free tool
        "vCenter converter",                          # vmware free tool
        "photon",                                     # vmware linux
        "supportability tools",                       # citrix free
        "enterprise browser",                         # citrix free client
        "workspace app", "citrix receiver",           # citrix free client
        "hana studio",                                # sap free client
        "netweaver business client",                  # sap free
    }
    if fam_l in freeware_families:                    return "Freeware"
    if "express" in fam_l and "sql" in fam_l:         return "Freeware"
    if "free" in met_l and "no license" in met_l:     return "Freeware"

    # ── Component rules ─────────────────────────────────────────────
    component_signals = [
        "not separately licensable", "bundled", "client agent",
        "language pack", "font pack", "runtime redistributable",
        "driver", "plugin", "add-in", "sdk", "toolkit",
    ]
    if any(s in met_l for s in component_signals):    return "Component"

    component_families = {
        "adobe acrobat/reader update component",
        "adobe acrobat/reader language pack",
        "adobe genuine software integrity service",
        "creative cloud desktop app", "creative cloud sync",
        "creative cloud libraries", "content authenticity initiative",
        "uxp extensions framework", "adobe os extension",
        "vmware tools",
        "sql server management tools", "sql server client tools",
        "sql server native client", "sql server clr types",
        "mq client", "websphere mq java",
        "websphere mq managed file transfer tools",
        "websphere mq managed file transfer logger",
        "websphere mq managed file transfer base",
        "host access toolkit",
        ...
        ".net framework", ".net runtime", ".net core",
        "visual c++ redistributable",
    }
    if fam_l in component_families:                   return "Component"

    # Sub-component name patterns
    if any(x in fam_l for x in [
        "client tool", "native client", "clr type", "data tool",
        "management tool", "command line tool", "notification service",
        "language pack", "update component", "shared component",
        "reporting add", "discovery agent", "monitoring agent",
        "inventory agent", "management agent", "endpoint agent",
    ]):
        return "Component"

    # ── Shareware rules ─────────────────────────────────────────────
    # Only confirmed shareware: Windows Server/SQL Server Evaluation editions
    if "evaluation" in fam_l or "evaluation" in str(ed).lower():
        return "Shareware"
...
for row in rows:
    cid, pub, fam, ed, ver, metric, aliases = row[0], row[1], row[2], row[3], row[4], row[5], row[6]
    existing = row[7] if len(row) > 7 else ""
    row_classification = _classify(cid, pub, fam, ed, metric, existing)
    if len(row) > 7:
        row[7] = row_classification
    else:
        row.append(row_classification)
