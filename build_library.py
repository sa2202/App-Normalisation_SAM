...
def _classify(cid, pub, fam, ed, metric, existing):
    ...
    # ── Freeware rules ──────────────────────────────────────────────
    # Publisher placeholder means we already know it's free
    if pub.startswith("(Freeware)"):          return "Freeware"
    if pub.startswith("(Open Source)"):       return "Freeware"
    ...
    # ── Component rules ─────────────────────────────────────────────
    if pub.startswith("(Component)"):                 return "Component"
    ...
    # ── Commercial (default for everything else with a real publisher) ─
