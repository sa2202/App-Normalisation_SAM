...
FILE_SIGNATURES = [
    ...
    # --- IBM: confirmed from real Flexera file evidence ---
    (r"^amqilaunchelevated\.exe$", None, "WebSphere MQ", "IBM", True),
    (r"^amqmcn\.exe$", None, "WebSphere MQ", "IBM", False),
    (r"^dsmc\.exe$", None, "Storage Protect (Tivoli Storage Manager)", "IBM", True),
    (r"^dsm\.exe$", None, "Storage Protect (Tivoli Storage Manager)", "IBM", True),
    (r"^dsmcad\.exe$", None, "Storage Protect (Tivoli Storage Manager)", "IBM", False),
    (r"^dsmadmc\.exe$", None, "Storage Protect (Tivoli Storage Manager)", "IBM", False),
    (r"^tsmjbbd\.exe$", None, "Storage Protect (Tivoli Storage Manager)", "IBM", False),
    (r"^sysctbl\.exe$", "pcomwin", "Personal Communications", "IBM", True),
    (r"^userpm\.exe$", "pcomwin", "Personal Communications", "IBM", False),
    (r"^zipprint\.exe$", "pcomwin", "Personal Communications", "IBM", False),
